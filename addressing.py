...
def content_focus(k_t,b_t,mem):
    ...
    """
    # Define a function that takes a vector u and computes the product
        # a: the similarity between u and the k and
        # b: b_t, the key strength
    def K(u):
      return np.exp( b_t * cosine_sim(u,k_t)  )

    # Apply that function to every row in the matrix
